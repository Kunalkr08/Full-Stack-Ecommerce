...
//         const stripePromise = await loadStripe('pk_test_51PYiHZRqQDS11hOU7RQJPxetmbHCU57MrwNwTyla5vYeDWbQBpDzUdKcnp2QMx7yenV5F5aofe7lW8aLGcg5EjLX00btSdcEMa')
                           ...
                           loading ? (
                            ...
                            (
                                <div className='h-36 bg-white'>
                                    ...
                                    <button className='bg-blue-600 p-1 text-white w-full' onClick={handlePayment}>Payment</button>
                                </div>
                            )
                        }
                      </div>
